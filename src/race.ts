...
export class Race {
    ...
    init(): void {
        ...
        carImg.innerHTML = `
        <div class="point-a">A</div>
        <div class="point-b">B</div>
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#fff" width="100px" height="60px" viewBox="0 -39.69 122.88 82.88" version="1.1" id="Layer_1" xml:space="preserve" transform="rotate(0)matrix(-1, 0, 0, 1, 0, 0)">
